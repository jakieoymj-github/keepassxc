...
void LightStyle::polish(QPalette& palette)
{
    ...
    palette.setColor(QPalette::Inactive, QPalette::Highlight, QStringLiteral("#58822B"));
    palette.setColor(QPalette::Disabled, QPalette::Highlight, QStringLiteral("#7CA654"));

    palette.setColor(QPalette::Active, QPalette::HighlightedText, QStringLiteral("#FFFFFF"));
    palette.setColor(QPalette::Inactive, QPalette::HighlightedText, QStringLiteral("#FFFFFF"));
    palette.setColor(QPalette::Disabled, QPalette::HighlightedText, QStringLiteral("#E8E8E8"));
